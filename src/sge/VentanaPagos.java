 ...
 * Clase: Ventana Principal de Pagos
...
public class VentanaPagos extends javax.swing.JInternalFrame {
    ...
    public VentanaPagos(int usuarioCedula) {
        initComponents();
        parametroCedula = usuarioCedula;
    }

    public int obtenerCedula() {
        return parametroCedula;
    }
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    ...
                    .addComponent(botonCuota, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
                .addGap(18, 18, 18)
    ...
    private void botonMatriculaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botonMatriculaActionPerformed
        limpiarPanel();
        VentanaPagosMatricula ventanaPagosMatricula = new VentanaPagosMatricula(obtenerCedula());
        PanelParaConsultas.add(ventanaPagosMatricula);
        ventanaPagosMatricula.setVisible(true);
        Icon imagen = obtenerIcono();
        ventanaPagosMatricula.setFrameIcon(imagen);
    ...
    private void botonCuotaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botonCuotaActionPerformed
        limpiarPanel();
        VentanaPagosCuota ventanaPagosCuota = new VentanaPagosCuota(obtenerCedula());
        PanelParaConsultas.add(ventanaPagosCuota);
        ventanaPagosCuota.setVisible(true);
        Icon imagen = obtenerIcono();
        ventanaPagosCuota.setFrameIcon(imagen);
